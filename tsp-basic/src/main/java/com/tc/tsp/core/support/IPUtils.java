...
public class IPUtils {
    ...
    private static void setHostAddress(String address) {
        ...
        List<String> hostAddressIpDigitals = OspStrings.split(address, '.', 4);
    ...
    public static String integer2IPV4(Integer iIPV4) {
        ...
        sb.append((0xff & (iIPV4 >> 24))).append('.').append((0xff & (iIPV4 >> 16))).append('.')
                .append((0xff & (iIPV4 >> 8))).append('.').append((0xff & (iIPV4)));
        result = sb.toString();
    ...
    public static Integer IPV42Integer(String strIPV4) {
        ...
        List<String> it = OspStrings.split(strIPV4, '.', 4);
        int tempInt;
    ...
    public static boolean isLocalPortUsing(int port) {
        try {
            ...
            logger.info("local host port {} doesn't use", port); // NOSONAR
            return false;
        }
    }
    ...
    public static boolean isPortUsing(String host, int port) throws UnknownHostException {
        ...
        try {
            ...
            OspIOs.closeQuietly(socket);
            return true;
        } catch (Exception e) {// NOSONAR
            logger.info(host + ':' + port + " doesn't use"); // NOSONAR
        }
        return false;
    }
